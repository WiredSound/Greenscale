...
public:
	...
	void fill(IDs::Tiles id, sf::Color colour, std::vector<sf::Vector2u> positions);
	void fillRect(IDs::Tiles id, sf::Vector2u pos, sf::Vector2u rectSize);
	void fillRect(IDs::Tiles id, sf::Color colour, sf::Vector2u pos, sf::Vector2u rectSize);
